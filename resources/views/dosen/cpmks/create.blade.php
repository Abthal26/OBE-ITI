...
<div class="max-w-2xl space-y-6">
    ...
    <div class="card p-8">
        <form action="{{ route('dosen.courses.cpmks.store', $course) }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <textarea 
                    ...
                    placeholder="Contoh: Mampu memahami konsep dasar algoritma..."
                    required
                            ...
                            <div class="w-32">
                                ...
                                <div class="relative">
                                    <input 
                                        ...
                                        value="{{ old('cpl_mappings.'.$loop->index.'.weight', 0) }}"
                                        min="0"
                                        max="100"
                                        step="0.01"
